-- Include visit expenses (Compras → otros gastos) as variable OpEx in profit summary.
...
begin
  ...
  -- Market-trip extras (gasolina, diablero, bolsas, caseta, etc.) — variable OpEx, not COGS.
  ...
  select
    ...
    round(v_revenue - v_cogs - v_fixed - v_variable - v_visit, 2),
    v_orders;
end;
$$;
